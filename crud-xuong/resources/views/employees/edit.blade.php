...
<div class="container">
    <form method="POST" action="{{ route('employees.update',$employee)}}" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="date" class="form-control" name="hire_date" id="hire_date"  value="{{ $employee->hire_date }}"/>
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="checkbox" class="form-checkbox" @checked($employee->is_active) value="1" name="is_active" id="is_active" value="{{ $employee->is_active}}"/>
            </div>
        </div>
        <div class="mb-3 row">
            <label for="department_id" class="col-4 col-form-label">department_id</label>
            <div class="col-8">
                <input type="text" class="form-control" name="department_id" id="department_id"  value="{{ $employee->department_id }}"/>
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="file" class="form-control" name="profile_picture" id="profile_picture" value="{{$employee->profile_picture}}"/>
